...
# Plot 1
plot(powerDT[, dateTime], powerDT[, Global_active_power], type = "l", xlab = "datetime", ylab = "Global Active Power")

# Plot 2
plot(powerDT[, dateTime], powerDT[, Voltage], type = "l", xlab = "datetime", ylab = "Voltage")

# Plot 3
plot(powerDT[, dateTime], powerDT[, Sub_metering_1], type = "l", xlab = "datetime", ylab = "Energy sub metering")
